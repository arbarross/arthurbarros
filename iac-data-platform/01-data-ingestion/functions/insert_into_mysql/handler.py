## no seu terminal execute o comando pip3 freeze para gerar seu requirements com todas as libs importadas
import os
import sys
import pymysql
...
##vams criar um try para verificar se a conexao com o banco de dados esta ok
try:
    conn = pymysql.connect(host=host, user=username, passwd=password, db=database, connect_timeout=5)
except pymysql.MySQLError as e:
    sys.exit()

##vamos usar alib Faker para gerar dados aleatorios
## toda funcaolambda precisa de um event que é o dado que esta chegando e o context é o envio que vamos usar para o kineses 
...
## nesse bloco utilizamos o cursor para executar o comando sql de criacao das tabelas que vamos utilizar
    with conn.cursor() as cur:
        ...
        """)
## com as tabelas criadas, vamos popular as tabelas com dados
